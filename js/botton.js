...
!function() {
    ...
    var e = window.document
      ...
      , F = function(e, t, o) {
        ...
        if (f.length < i.length || ("." + f).substring(f.length - i.length) !== "." + i)
            return c.removeAttribute("href"),
            void o(s);
        var h = (" /" + c.pathname).split(/\/+/);
        if (((f === i || f === "gist." + i) && "archive" === h[3] || f === i && "releases" === h[3] && ("download" === h[4] || "latest" === h[4] && "download" === h[5]) || f === "codeload." + i) && (c.target = "_top"),
        "true" === m(t["data-show-count"]) && f === i) {
            var u, p;
            if (!h[2] && h[1])
                p = "followers",
                u = "?tab=followers";
    ...
    t.protocol + "//" + t.host + t.pathname === n ? F(e.body, d(window.name || t.hash.replace(/^#/, "")), (function() {}
    )) : function(t) {
        if ("complete" === e.readyState || "loading" !== e.readyState && !e.documentElement.doScroll)
            setTimeout(t);
        else if (e.addEventListener) {
            var o = b(t);
            h(e, "DOMContentLoaded", o),
            h(window, "load", o)
        } else
            u(e, /m/, t)
    }((function() {
